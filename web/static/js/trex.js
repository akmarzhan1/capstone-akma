!(function () {
    ...
    function t(s, e) {
      ...
      (t.instance_ = this),
        (this.outerContainerEl = document.querySelector(s)),
        (this.containerEl = null),
        (this.config = e || t.config),
    ...
    function d(t, i, s, e, h, o) {
      (this.canvasCtx = t),
        ...
        (this.size = n(1, d.MAX_OBSTACLE_LENGTH)),
        (this.dimensions = e),
        (this.remove = !1),
        (this.xPos = 0),
    ...
    function m(t, i, s) {
      (this.canvas = t),
        ...
        (this.yPos = 0),
        (this.remove = !1),
        (this.cloudGap = n(m.config.MIN_CLOUD_GAP, m.config.MAX_CLOUD_GAP)),
        this.init();
    }
    ...
    function I(t, i, s, e) {
      (this.canvas = t),
        ...
        (this.clouds = []),
        (this.cloudImg = i.CLOUD),
        (this.cloudSpeed = this.config.BG_CLOUD_SPEED),
        (this.horizonImg = i.HORIZON),
    ...
    (t.config = {
      ...
      (t.prototype = {
        ...
        loadImages: function () {
          for (
            var i = s ? t.imageSources.HDPI : t.imageSources.LDPI,
              e = i.length - 1;
            e >= 0;
            e--
          ) {
        ...
        init: function () {
          var i, s, n, h, o;
          (document.querySelector("." + t.classes.ICON).style.visibility =
            "hidden"),
            ...
            (this.canvas =
              ...
              (h = t.classes.PLAYER),
              ((o = document.createElement("canvas")).className = h
                ? t.classes.CANVAS + " " + h
                : t.classes.CANVAS),
              (o.width = s),
              (o.height = n),
            ...
            (this.tRex = new u(this.canvas, this.images.TREX)),
            this.outerContainerEl.appendChild(this.containerEl),
            e && this.createTouchController(),
            this.startListening(),
            this.update(),
        ...
        adjustDimensions: function () {
          ...
          (this.dimensions.WIDTH =
            this.outerContainerEl.offsetWidth - 2 * s > 600
              ? 600
              : this.outerContainerEl.offsetWidth - 2 * s),
            this.canvas &&
        ...
        update: function () {
          ...
          if (((this.time = i), this.activated)) {
            this.clearCanvas(),
              this.tRex.jumping && this.tRex.updateJump(s, this.config),
              (this.runningTime += s);
            ...
            1 != this.tRex.jumpCount || this.playingIntro || this.playIntro(),
              this.playingIntro
                ...
                : ((s = this.started ? s : 0),
                  this.horizon.update(s, this.currentSpeed, e)),
              e &&
              (function (i, s, e) {
                ...
                if (r(n, h))
                  for (
                    var d = i.collisionBoxes, l = u.collisionBoxes, m = 0;
                    m < l.length;
                    m++
                  )
                ...
                ? this.gameOver()
                : ((this.distanceRan +=
                    (this.currentSpeed * s) / this.msPerFrame),
                  this.currentSpeed < this.config.MAX_SPEED &&
                    (this.currentSpeed += this.config.ACCELERATION)),
              this.distanceMeter.getActualDistance(this.distanceRan) >
                this.distanceMeter.maxScore && (this.distanceRan = 0),
              this.distanceMeter.update(s, Math.ceil(this.distanceRan)) &&
        ...
        startListening: function () {
          document.addEventListener(t.events.KEYDOWN, this),
            ...
            e
              ? (this.touchController.addEventListener(t.events.TOUCHSTART, this),
          ...
          document.removeEventListener(t.events.KEYDOWN, this),
            ...
            e
              ? (this.touchController.removeEventListener(
                ...
                this.containerEl.removeEventListener(t.events.TOUCHSTART, this))
              : (document.removeEventListener(t.events.MOUSEDOWN, this),
                document.removeEventListener(t.events.MOUSEUP, this));
        },
        onKeyDown: function (i) {
          this.crashed ||
            (!t.keycodes.JUMP[String(i.keyCode)] &&
              i.type != t.events.TOUCHSTART) ||
            (this.activated || (this.loadSounds(), (this.activated = !0)),
            this.tRex.jumping ||
              (this.playSound(this.soundFx.BUTTON_PRESS), this.tRex.startJump())),
            this.crashed &&
              i.type == t.events.TOUCHSTART &&
              i.currentTarget == this.containerEl &&
              this.restart(),
            t.keycodes.DUCK[i.keyCode] &&
              this.tRex.jumping &&
              (i.preventDefault(), this.tRex.setSpeedDrop());
        },
        onKeyUp: function (i) {
          var s = String(i.keyCode),
            e =
              t.keycodes.JUMP[s] ||
              i.type == t.events.TOUCHEND ||
              i.type == t.events.MOUSEDOWN;
          if (this.isRunning() && e) this.tRex.endJump();
          else if (t.keycodes.DUCK[s]) this.tRex.speedDrop = !1;
          else if (this.crashed) {
            var n = performance.now() - this.time;
            (t.keycodes.RESTART[s] ||
              (i.type == t.events.MOUSEUP && i.target == this.canvas) ||
              (n >= this.config.GAMEOVER_CLEAR_TIME && t.keycodes.JUMP[s])) &&
              this.restart();
      ...
      (h.prototype = {
        ...
        draw: function () {
          ...
          s && ((n *= 2), (e *= 2), (o *= 2), (a *= 2), (l *= 2), (m *= 2)),
            this.canvasCtx.drawImage(this.textSprite, e, n, o, a, r, c, d, u),
      ...
      (d.MAX_GAP_COEFFICIENT = 1.5),
      (d.MAX_OBSTACLE_LENGTH = 3),
      (d.prototype = {
        init: function (t) {
        ...
        draw: function () {
          ...
          s && ((t *= 2), (i *= 2));
          var e = t * this.size * (0.5 * (this.size - 1));
          this.canvasCtx.drawImage(
            this.image,
            e,
            0,
        ...
        update: function (t, s) {
          this.remove ||
            ((this.xPos -= Math.floor(((s * i) / 1e3) * t)),
            this.draw(),
        ...
        update: function (t, i) {
          (this.timer += t),
            i &&
              ...
              i == u.status.WAITING &&
                ((this.animStartTime = performance.now()), this.setBlinkDelay())),
            this.playingIntro &&
        ...
        updateJump: function (t) {
          ...
          this.speedDrop
            ? (this.yPos += Math.round(
                this.jumpVelocity * this.config.SPEED_DROP_COEFFICIENT * i
              ))
      ...
      (l.prototype = {
        init: function (t) {
          ...
          for (var s = 0; s < this.config.MAX_DISTANCE_UNITS; s++)
            this.draw(s, 0), (this.defaultString += "0"), (i += "9");
          this.maxScore = parseInt(i);
        },
        calcXPos: function (t) {
          this.x =
            t - l.dimensions.DEST_WIDTH * (this.config.MAX_DISTANCE_UNITS + 1);
        },
        draw: function (t, i, e) {
          ...
          if ((s && ((n *= 2), (h *= 2), (o *= 2)), this.canvasCtx.save(), e)) {
            var u =
              this.x - 2 * this.config.MAX_DISTANCE_UNITS * l.dimensions.WIDTH;
            this.canvasCtx.translate(u, this.y);
          } else this.canvasCtx.translate(this.x, this.y);
          this.canvasCtx.drawImage(this.image, o, 0, n, h, a, r, c, d),
        ...
        update: function (t, i) {
          ...
          if (this.acheivement)
            ...
            var n = (this.defaultString + i).substr(
        ...
        setHighScore: function (t) {
          ...
          var i = (this.defaultString + t).substr(
            -this.config.MAX_DISTANCE_UNITS
          );
      ...
      (m.prototype = {
        init: function () {
          (this.yPos = n(m.config.MAX_SKY_LEVEL, m.config.MIN_SKY_LEVEL)),
            this.draw();
        },
        draw: function () {
          this.canvasCtx.save();
      ...
      (T.prototype = {
        setSourceDimensions: function () {
          for (var t in T.dimensions)
            s
              ? "YPOS" != t && (this.sourceDimensions[t] = 2 * T.dimensions[t])
              : (this.sourceDimensions[t] = T.dimensions[t]),
              (this.dimensions[t] = T.dimensions[t]);
        ...
        updateXPos: function (t, i) {
          ...
          (this.xPos[s] -= i),
            ...
            this.xPos[s] <= -this.dimensions.WIDTH &&
              ...
              (this.xPos[e] = this.xPos[s] - this.dimensions.WIDTH),
              (this.sourceXPos[s] = this.getRandomType()));
        },
        update: function (t, s) {
      ...
      (I.prototype = {
        init: function () {
          this.addCloud(),
            (this.horizonLine = new T(this.canvas, this.horizonImg));
        },
        ...
        addNewObstacle: function (t) {
          ...
          this.obstacles.push(
            new d(this.canvasCtx, s, e, this.dimensions, this.gapCoefficient, t)
          );
        },
        reset: function () {
        ...
        addCloud: function () {
          this.clouds.push(
            new m(this.canvas, this.cloudImg, this.dimensions.WIDTH)
          );
        }
      });
  })(),
      ...
      window.tRexBot = setInterval(function () {
        ...
        if (
          ...
          obstacles[0].xPos + obstacles[0].width <=
            (parseInt(Runner.instance_.currentSpeed - 0.1) - 5) * 34 + 160 &&
